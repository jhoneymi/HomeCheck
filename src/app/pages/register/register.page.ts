...
import { IonContent, IonButton, IonInput, IonSelect, IonSelectOption, IonIcon, LoadingController, AlertController } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [
    IonContent, IonButton, IonInput, IonSelect, IonSelectOption, IonIcon,
