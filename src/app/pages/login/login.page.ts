...
import { IonContent, IonHeader, IonTitle, IonToolbar, IonButton, IonInput, IonItem, IonList } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [
    IonContent, IonHeader, IonTitle, IonToolbar, IonButton, IonInput, IonItem, IonList, 
